                    ...
                    <div class="container-fluid">
                        <div class="row">
                         ...
                         <div class="col-md-4">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title"><strong>Projetos Criados</strong></h4>
                                    ...
                                    <div class="header">
                                     ...
                                     <%
                                         ...
                                         ArrayList<Project> ProjectDate = (ArrayList<Project>) request.getAttribute("ProjectListNames");
                                 ...
                                 <div class="content">
                                     ...
                                     <div class="row"> 
                                          ...
                                          <h3><a href="${pageContext.request.contextPath}/ProjectHome?PID=<%out.println(Project.getPID());%>&CID=<%out.println(Project.getCID());%>"><%out.println(Project.getPNome());%></a></h3><br>
                                         <%}%>
                                     </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$.notify({
			icon: 'pe-7s-star',
			message: "Bem vindo ao SiOriente <br> <b>Mudando o mundo com ideias</b>."
